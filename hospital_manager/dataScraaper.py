...
# main_lnk = 'https://portal.edcd.gov.np/covid19/'

main_lnk='https://covid19.mohp.gov.np/'

health_source = requests.get(main_lnk, verify=False)
print(health_source)
...
#             content = ['स्वास्थ्य तथा जनसंख्या मन्त्रालय', src_img, dateandtime, [content], lnk, Source, main_lnk,
#                        False]
#             main_lst.append(content)
#         return main_lst
#     except:
